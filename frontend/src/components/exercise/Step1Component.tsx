    ...
    return (
        <div className="max-w-2xl mx-auto p-4 bg-white rounded-lg shadow-md space-y-4">
            <div className="mb-4">
                ...
                <p className='text-sm'>
                Note: In order to measure calories burned more accurately, please register standing time, sleeping time, work and housework time, in addition to general physical activity, if possible.
                </p>
            </div>
