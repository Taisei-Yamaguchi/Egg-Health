...
export function CreateExerciseSetButton() {
    ...
    return (
        <div className="relative inline-block">
            <button
                className="flex items-center px-3 py-1 text-xs font-medium text-white bg-gradient-to-r from-rose-400 to-rose-600 rounded-md shadow hover:from-rose-500 hover:to-rose-700 focus:outline-none focus:ring-2"
                onClick={handleClick}
            >
