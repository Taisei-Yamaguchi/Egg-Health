    ...
    return (
        ...
        <section className="w-[95%] md:w-[80%] mx-auto py-10">
            ...
            <section className="mb-5">
                ...
                <p className="block w-full h-10 rounded-md px-4 py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 pl-2">
                    {data && data.username}
                </p>
            </section>
